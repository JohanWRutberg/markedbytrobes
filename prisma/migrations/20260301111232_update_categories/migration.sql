...
-- CreateEnum
CREATE TYPE "Category" AS ENUM ('ROMANCE', 'ROMANTASY', 'FANTASY', 'DARK_ROMANCE', 'THRILLER', 'BOOK_LISTS', 'SEASONAL_READS', 'FICTION', 'HISTORICAL_FICTION', 'CONTEMPORARY', 'HISTORICAL', 'SPORTS_ROMANCE');
...
CREATE TABLE "Book" (
    ...
    "whoFor" TEXT,
    "emotionalPoints" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateIndex
CREATE INDEX "Book_postId_idx" ON "Book"("postId");
